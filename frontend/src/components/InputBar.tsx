...
export const InputBar = forwardRef<InputBarHandle, InputBarProps>(function InputBar(
  ...
  return (
    <div className="border-t border-zinc-800/60 px-4 py-3">
      <div className="max-w-3xl mx-auto w-full flex items-center gap-2 bg-zinc-900 border border-zinc-700 rounded-2xl px-4 py-2.5 focus-within:border-violet-500 transition-colors">
        <textarea
          ref={textareaRef}
          value={value}
